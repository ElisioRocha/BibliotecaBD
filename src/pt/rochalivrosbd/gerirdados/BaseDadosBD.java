...
public class BaseDadosBD {
 ...
 // private static ArrayList <BandaDesenhada> coleçãoBD = new ArrayList();//osDaltons, unicorno, oFoguetão, osRomanos;
    ...
    public static ArrayList setBaseDadosBD() {
        ArrayList <Autor> coleçãoAutores = new ArrayList();
        ...
        ArrayList <BandaDesenhada> coleçãoBD = new ArrayList();
    ...
    /* Inicialmente guardava a coleção de Bandas Desenhadas num Field private desta classe
